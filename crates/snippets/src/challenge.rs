...
static CHALLENGES: &[Challenge] = &[
  ...
  Challenge {
    ...
    title: "Parse error",
    project: "strum",
    source_path: "strum/src/lib.rs",
    license: "MIT",
    level: 1,
    accuracy_goal: TWO_STAR_ACCURACY,
    wpm_goal: 33.0,
    code: include_str!("../../../challenges/strum/01-parse-error.rs"),
  },
  Challenge {
    id: "challenge-st-02",
    title: "Helper errors",
    project: "strum",
    source_path: "strum_macros/src/helpers/mod.rs",
    license: "MIT",
    level: 2,
    accuracy_goal: TWO_STAR_ACCURACY,
    wpm_goal: 35.0,
    code: include_str!("../../../challenges/strum/02-helper-errors.rs"),
  },
  Challenge {
    id: "challenge-st-03",
    title: "Inner variant props",
    project: "strum",
    source_path: "strum_macros/src/helpers/inner_variant_props.rs",
    license: "MIT",
    level: 3,
    accuracy_goal: TWO_STAR_ACCURACY,
    wpm_goal: 37.0,
    code: include_str!("../../../challenges/strum/03-inner-variant-props.rs"),
  },
  Challenge {
    id: "challenge-st-04",
    title: "Static variants array",
    project: "strum",
    source_path: "strum_macros/src/macros/enum_variant_array.rs",
    license: "MIT",
    level: 4,
    accuracy_goal: TWO_STAR_ACCURACY,
    wpm_goal: 39.0,
    code: include_str!("../../../challenges/strum/04-variant-array.rs"),
  },
  Challenge {
    id: "challenge-st-05",
    title: "Variant names",
    project: "strum",
    source_path: "strum_macros/src/macros/enum_variant_names.rs",
    license: "MIT",
    level: 5,
    accuracy_goal: TWO_STAR_ACCURACY,
    wpm_goal: 41.0,
    code: include_str!("../../../challenges/strum/05-variant-names.rs"),
  },
  Challenge {
    id: "challenge-st-06",
    title: "Single field extraction",
    project: "strum",
    source_path: "strum_macros/src/macros/strings/mod.rs",
    license: "MIT",
    level: 6,
    accuracy_goal: TWO_STAR_ACCURACY,
    wpm_goal: 44.0,
    code: include_str!("../../../challenges/strum/06-single-field-extraction.rs"),
  },
];
