...
- **Challenges** - curated levels cut from real projects, six each from
  ripgrep, serde, hashbrown, proptest and tokio to start. Every level carries
  its source path and license, and pays up to three stars for speed and
  accuracy. No gates; only stars.
